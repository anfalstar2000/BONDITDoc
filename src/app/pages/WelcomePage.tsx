    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8 not-prose">
          <div className="p-6 bg-white rounded-[15px]">
        ...
        <div className="bg-white rounded-[15px] p-4 my-6">
        ...
        <div className="bg-white rounded-[15px] p-8 my-6">
        ...
        <div className="bg-[#3B82F6] rounded-[15px] text-white p-8 my-8 not-prose">
          ...
          <button className="px-6 py-3 bg-white rounded-[15px] text-[#3B82F6] font-semibold hover:bg-[#F7F7F7] transition-colors">
            ابدأ الآن
          </button>
        </div>

        <div className="bg-black rounded-[15px] text-white p-8 my-8 text-center not-prose bg-[#ededed]">
