    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8 not-prose">
          <div className="p-6 bg-white rounded-[15%]">
            <div className="size-12 bg-[#3B82F6] rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="bg-white rounded-[15%] p-6 my-6">
          <p className="text-black font-semibold mb-2">⚠️ حقيقة مهمة:</p>
          <p className="text-black">
        ...
        <div className="bg-white rounded-[15%] p-4 my-6">
        ...
        <div className="bg-white rounded-[15%] p-8 my-6">
        ...
        <div className="bg-[#3B82F6] rounded-[15%] text-white p-8 my-8 not-prose">
          ...
          <button className="px-6 py-3 bg-white rounded-[15%] text-[#3B82F6] font-semibold hover:bg-[#F7F7F7] transition-colors">
            ابدأ الآن
          </button>
        </div>

        <div className="bg-black rounded-[15%] text-white p-8 my-8 text-center not-prose bg-[#ededed]">
          <p className="text-2xl font-bold mb-2">BOND IT ليس مجرد نظام نقاط…</p>
          <p className="text-xl text-[#939393]">بل أداة لبناء ولاء حقيقي داخل متجرك.</p>
        </div>
      </div>
    </div>
  );
