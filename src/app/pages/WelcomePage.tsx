  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-white rounded-none border border-gray-100 p-4 my-6">
        ...
        <div className="bg-[#3B82F6] rounded-none text-white p-6 my-8 not-prose">
          ...
          <button className="px-6 py-3 bg-white rounded-none border border-gray-100 text-[#3B82F6] font-semibold hover:bg-gray-50 transition-colors">
            ابدأ الآن
          </button>
        </div>
