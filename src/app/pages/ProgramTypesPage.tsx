    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-3 gap-3 mb-4">
                <div className="p-3 bg-[#F7F7F7] rounded-[15%] text-center">
              ...
              <p className="text-sm text-[#939393] mb-4 bg-[#F7F7F7] rounded-[15%] p-3">
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6">
              ...
              <div className="bg-[#F7F7F7] rounded-[15%] p-5 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-black p-3 bg-white rounded-[15%]">
        ...
        <div className="grid md:grid-cols-2 gap-4 my-6 not-prose">
          <div className="p-5 bg-white rounded-[15%]">
