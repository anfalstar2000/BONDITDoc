    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h3 className="text-2xl font-bold text-white">1️⃣ النقاط والمكافآت</h3>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="bg-[#F7F7F7] rounded-none p-5 mb-4">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h3 className="text-2xl font-bold text-white">2️⃣ الشارات والمستويات</h3>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-3 gap-3 mb-4">
                <div className="p-3 bg-[#F7F7F7] rounded-none text-center">
              ...
              <p className="text-sm text-[#939393] mb-4 bg-[#F7F7F7] rounded-none p-3">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h3 className="text-2xl font-bold text-white">3️⃣ التحديات</h3>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="bg-[#F7F7F7] rounded-none p-5 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-black p-3 bg-white rounded-none">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h3 className="text-2xl font-bold text-white">4️⃣ برنامج الإحالة</h3>
              </div>
          ...
          <div className="rounded-none overflow-hidden bg-white">
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h3 className="text-2xl font-bold text-white">5️⃣ الرسائل التلقائية</h3>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-3 mb-4">
                <div className="p-3 bg-[#F7F7F7] rounded-none">
            ...
            <div className="bg-[#3B82F6] p-6">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white">6️⃣ المساعد الذكي</h3>
        ...
        <div className="grid md:grid-cols-2 gap-4 my-6 not-prose">
          <div className="p-5 bg-white rounded-none">
