    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white rounded-none p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-[#F7F7F7] rounded-none">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="grid md:grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white rounded-none md:col-span-2">
                    <TrendingUp className="size-5 text-[#3B82F6] shrink-0 mt-0.5" />
        ...
        <div className="bg-[#3B82F6] rounded-none text-white p-8 my-8 text-center not-prose">
          ...
          <button className="px-6 py-3 bg-white text-[#3B82F6] font-semibold rounded-none hover:bg-[#F7F7F7] transition-colors">
            استكشف الميزات
          </button>
        </div>
      </div>
