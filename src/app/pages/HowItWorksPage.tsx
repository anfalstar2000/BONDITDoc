    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-8 my-12 not-prose">
          ...
          <div className="relative">
            <div className="flex items-start gap-6">
              <div className="shrink-0">
                <div className="size-16 bg-[#3B82F6] rounded-lg flex items-center justify-center">
                  <Download className="size-8 text-white" />
                </div>
              </div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-black mb-3">
                  1️⃣ تثبيت التطبيق وربط المتجر
                </h3>
                <p className="text-black mb-4">
                  بعد تثبيت BOND IT من متجر تطبيقات سلة:
                </p>
                <div className="space-y-3 mb-4">
                  <div className="flex items-start gap-3 p-4 bg-white rounded-[15px]">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white rounded-[15px] p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-[#F7F7F7] rounded-[15px]">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white rounded-[15px] p-6">
                  ...
                  <p className="text-sm text-black mt-4">
                    <strong>⚙️ مرونة كاملة:</strong> يمكنك أنت تحديد شروط كل مكافأة وحدود استخدامها.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-black mb-3">
                  4️⃣ أنت تتابع الأداء وتطور البرنامج
                </h3>
                <p className="text-black mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white rounded-[15px] md:col-span-2">
                    <TrendingUp className="size-5 text-[#3B82F6] shrink-0 mt-0.5" />
        ...
        <div className="grid md:grid-cols-2 gap-4 my-6 not-prose">
          <div className="flex items-start gap-3 p-5 bg-white rounded-[15px]">
        ...
        <div className="bg-[#3B82F6] rounded-[15px] text-white p-8 my-8 text-center not-prose">
          ...
          <button className="px-6 py-3 bg-white text-[#3B82F6] font-semibold rounded-[15px] hover:bg-[#F7F7F7] transition-colors">
            استكشف الميزات
          </button>
        </div>
      </div>
