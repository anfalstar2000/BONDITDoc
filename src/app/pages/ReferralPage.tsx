      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-6 my-8 not-prose">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-[#F7F7F7] rounded-[15%] p-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white rounded-[15%]">
                    <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="bg-[#F7F7F7] rounded-[15%] p-4">
                <p className="font-semibold text-black">🛡️ حماية:</p>
                <p className="text-black text-sm">
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[#F7F7F7] rounded-[15%] p-5 text-center">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
              ...
              <div>
                ...
                <p className="text-[#939393] text-sm">مقارنة بالإعلانات المدفوعة.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
              <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
              <div>
                ...
                <p className="text-[#939393] text-sm">التوصية من صديق أقوى من الإعلان.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
              <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
              <div>
                ...
                <p className="text-[#939393] text-sm">كل عميل يجلب عملاء جدد.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
              <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">4</span>
              <div>
                ...
                <p className="text-[#939393] text-sm">العميل يشعر بالانتماء عندما يوصي بمتجرك.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[15%] p-6 my-8 not-prose">
          ...
          <div className="space-y-4">
            <div className="bg-[#F7F7F7] rounded-[15%] p-5">
              ...
              <p className="text-[#939393] text-sm">أحمد (عميل حالي) يحصل على رابط إحالة خاص من لوحة الولاء.</p>
            </div>
            ...
            <div className="bg-[#F7F7F7] rounded-[15%] p-5">
              ...
              <p className="text-[#939393] text-sm">خالد (صديق أحمد) يدخل المتجر عبر رابط الإحالة.</p>
            </div>
            ...
            <div className="bg-[#F7F7F7] rounded-[15%] p-5">
              ...
              <p className="text-[#939393] text-sm">خالد يحصل على 10% خصم على أول طلب.</p>
            </div>
            ...
            <div className="bg-[#F7F7F7] rounded-[15%] p-5">
              ...
              <p className="text-[#939393] text-sm">خالد يُتم أول طلب له.</p>
            </div>

            <div className="bg-[#3B82F6] rounded-lg p-5">
              <div className="flex items-center gap-3 mb-3">
        ...
        <div className="bg-white rounded-[15%] p-6 my-8 not-prose">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-[#3B82F6] rounded-lg p-5 text-white">
