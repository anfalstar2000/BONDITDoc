          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="bg-[#F7F7F7] rounded-[15px] p-5">
                ...
                <div className="bg-white rounded-[15px] p-4 mb-3">
                  <p className="text-black font-semibold mb-2">أمثلة:</p>
                  <div className="space-y-2">
                    <div className="bg-[#F7F7F7] rounded-[15px] p-3 text-black">أكمل 3 طلبات</div>
                    <div className="bg-[#F7F7F7] rounded-[15px] p-3 text-black">أنفق 2000 ريال</div>
                    <div className="bg-[#F7F7F7] rounded-[15px] p-3 text-black">تحدي الإطلاق الجديد</div>
                  </div>
                </div>
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-[#F7F7F7] rounded-[15px] p-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-3 bg-white rounded-[15px]">
