...
export default function ChallengesPage() {
 ...
 <div className="bg-white rounded-none hover:bg-gray-50 transition-colors p-4 mb-3">
 <p className="text-black font-semibold mb-2">أمثلة:</p>
 <div className="space-y-2">
 <div className="bg-gray-50 rounded-3xl p-3 text-black">أكمل 3 طلبات</div>
 <div className="bg-gray-50 rounded-3xl p-3 text-black">أنفق 2000 ريال</div>
 <div className="bg-gray-50 rounded-3xl p-3 text-black">تحدي الإطلاق الجديد</div>
 </div>
 </div>
 ...
 <div className="space-y-2">
 <div className="flex items-start gap-3 p-3 bg-white rounded-none hover:bg-gray-50 transition-colors">
 <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
 ...
 <div className="space-y-2">
 <div className="flex items-center justify-between p-3 bg-white rounded-none hover:bg-gray-50 transition-colors">
