              ...
              <div className="bg-[#F7F7F7] rounded-lg p-5">
                ...
                <div className="bg-white rounded-lg p-4 mb-3">
                  ...
                  <div className="space-y-2">
                    <div className="bg-[#F7F7F7] rounded-lg p-3 text-black">أكمل 3 طلبات</div>
                    <div className="bg-[#F7F7F7] rounded-lg p-3 text-black">أنفق 2000 ريال</div>
                    <div className="bg-[#F7F7F7] rounded-lg p-3 text-black">تحدي الإطلاق الجديد</div>
                  </div>
                </div>
