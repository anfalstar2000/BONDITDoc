    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid grid-cols-3 gap-4 my-6 not-prose">
          <div className="bg-white rounded-none p-5 text-center">
        ...
        <div className="space-y-6 my-8 not-prose">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="bg-[#F7F7F7] rounded-none p-5 mt-4">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="p-4 bg-[#F7F7F7] rounded-none">
                  <div className="flex items-start gap-2 text-black">
                    <span className="size-6 shrink-0 bg-[#3B82F6] text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
        ...
        <div className="bg-white rounded-none p-6 my-8 not-prose">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {/* Silver Tier */}
            <div className="bg-[#F7F7F7] rounded-none overflow-hidden">
          ...
          <div className="mt-6 bg-[#F7F7F7] rounded-none p-5">
