  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-white rounded-[15%] overflow-hidden my-8 not-prose">
        ...
        <div className="bg-white rounded-[15%] p-6 my-8 not-prose">
          ...
          <div className="bg-[#F7F7F7] rounded-[15%] p-4 mt-4">
            <p className="font-semibold text-black">⚙️ تحكم كامل:</p>
            <p className="text-black text-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-4 bg-white rounded-[15%]">
                  ...
                  <div>
                    ...
                    <p className="text-[#939393] text-sm">بصلاحيات كاملة.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-[15%]">
                  <Activity className="size-6 text-[#3B82F6] shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="text-[#939393] text-sm">للحملات والمحتوى.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-[15%]">
                  <DollarSign className="size-6 text-[#3B82F6] shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="text-[#939393] text-sm">للتقارير والفواتير.</p>
                  </div>
                </div>
              </div>
            </div>
