        ...
        <div className="grid md:grid-cols-3 gap-6 my-12 not-prose">
          ...
          <div className="bg-white rounded-[15px] overflow-hidden">
            <div className="bg-white p-6">
              <div className="inline-block bg-[#F7F7F7] rounded-[15px] text-black px-4 py-1 text-sm font-semibold mb-4">
                متاجر صغيرة
              </div>
            ...
            <div className="p-6">
              <div className="bg-[#F7F7F7] rounded-[15px] p-4 mb-6 text-center">
              ...
              <a 
                ...
                className="block w-full py-3 bg-[#F7F7F7] hover:bg-[#3B82F6] hover:text-white text-black font-bold transition-all text-center rounded-[15px]"
              >
                اختر هذه الباقة
              </a>
            </div>
          ...
          <div className="bg-white rounded-[15px] overflow-hidden relative">
