    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        <div className="bg-white rounded-[15%] p-6 my-8 not-prose">
          ...
          <div className="flex items-center gap-4 p-4 bg-[#F7F7F7] rounded-[15%]">
            ...
            <div>
              ...
              <p className="text-[#939393]">عميل في متجر عطور إلكتروني</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8 my-12 not-prose">
          ...
          <div className="relative">
            <div className="flex gap-6">
              <div className="flex flex-col items-center">
                ...
                <div className="w-0.5 h-full bg-[#F7F7F7] mt-2"></div>
              </div>
              
              <div className="flex-1 pb-8">
                <h3 className="text-2xl font-bold text-black mb-2">1️⃣ أول طلب</h3>
                <p className="text-black mb-4">
                  أحمد يزور متجرك ويشتري عطرًا بقيمة 300 ريال.
                </p>
                
                <div className="bg-white rounded-[15%] p-5 mb-4">
                ...
                <div className="bg-white rounded-[15%] p-5">
                  ...
                  <div className="bg-[#F7F7F7] rounded-[15%] p-3">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                <h3 className="text-2xl font-bold text-black mb-2">2️⃣ بعد أيام: تفاعل</h3>
                <p className="text-black mb-4">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                <h3 className="text-2xl font-bold text-black mb-2">3️⃣ اقتراب من المكافأة</h3>
                <p className="text-black mb-4">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                <h3 className="text-2xl font-bold text-black mb-2">4️⃣ استبدال المكافأة</h3>
                <p className="text-black mb-4">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-black mb-2">5️⃣ الترقية لمستوى أعلى (إن وجد)</h3>
                <p className="text-black mb-4">
                ...
                <div className="bg-[#3B82F6] rounded-[15%] text-white p-6">
        ...
        <div className="bg-[#3B82F6] rounded-[15%] text-white p-8 my-8 not-prose text-center">
