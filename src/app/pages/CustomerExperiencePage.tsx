    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        <div className="bg-white rounded-[15px] p-6 my-8 not-prose">
          ...
          <div className="flex items-center gap-4 p-4 bg-[#F7F7F7] rounded-[15px]">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                ...
                <div className="bg-white rounded-[15px] p-5 mb-4">
          ...
          <div className="relative">
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="bg-[#3B82F6] rounded-[15px] text-white p-6">
        ...
        <div className="bg-[#3B82F6] rounded-[15px] text-white p-8 my-8 not-prose text-center">
