    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-4 my-6 not-prose">
          <div className="p-4 bg-white rounded-[15%]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 my-8 not-prose">
          <div className="p-5 bg-white rounded-[15%] text-center">
          ...
          <div className="p-5 bg-white rounded-[15%] text-center md:col-span-2 lg:col-span-1">
            <div className="size-12 bg-[#3B82F6] rounded-full flex items-center justify-center mx-auto mb-3 text-white">
              ✓
            </div>
        ...
        <div className="bg-white rounded-[15%] p-8 my-6">
          ...
          <div className="bg-[#F7F7F7] rounded-[15%] p-6 space-y-3">
            <p className="text-black">
        ...
        <div className="bg-black rounded-[15%] text-white p-8 my-8 not-prose">
