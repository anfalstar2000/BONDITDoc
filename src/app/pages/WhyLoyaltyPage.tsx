...
export default function WhyLoyaltyPage() {
 ...
 <div className="flex-1">
 <h3 className="text-xl font-bold text-black mb-2">2⃣ رفع متوسط قيمة الطلب</h3>
 <p className="text-black">
 ...
 <div className="flex-1">
 <h3 className="text-xl font-bold text-black mb-2">3⃣ بناء طبقة عملاء VIP</h3>
 <p className="text-black">
 ...
 <div className="flex-1">
 <h3 className="text-xl font-bold text-black mb-2">4⃣ إطلاق منتجات بذكاء</h3>
