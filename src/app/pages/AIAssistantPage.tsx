import { Sparkles, Wand2, FileText, Search, MessageCircle, Target, CheckCircle2, Lightbulb, ShoppingBag, TrendingUp, Share2, Zap } from 'lucide-react';
export default function AIAssistantPage() {
 ...
 src="https://www.youtube.com/embed/REwgYE8DJAo"
 title="شرح فيديو: استخدام المساعد الذكي"
 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
 allowFullScreen
 />
 </div>
 <div className="p-5 bg-white">
 <p className="text-black font-semibold text-lg mb-2">شرح فيديو: استخدام المساعد الذكي</p>
