        ...
        <div className="space-y-6 my-8 not-prose">
          ...
          <div className="rounded-none overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-none">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-2 bg-white rounded-none text-sm text-black text-center">خصم</div>
                    <div className="p-2 bg-white rounded-none text-sm text-black text-center">شحن مجاني</div>
                    <div className="p-2 bg-white rounded-none text-sm text-black text-center">منتج مجاني</div>
                    <div className="p-2 bg-white rounded-none text-sm text-black text-center">كاش باك</div>
                  </div>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-none">
              ...
              <div className="bg-[#F7F7F7] rounded-none p-4 text-sm">
