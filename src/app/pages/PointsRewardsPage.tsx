    ...
    <div className="max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-white rounded-[15%] p-6 my-8 not-prose">
          ...
          <div className="bg-[#F7F7F7] rounded-[15%] p-5 mb-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 bg-[#F7F7F7] rounded-[15%]">
        ...
        <div className="space-y-6 my-8 not-prose">
          ...
          <div className="rounded-lg overflow-hidden bg-white">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-2 bg-white rounded-[15%] text-sm text-black text-center">خصم</div>
                    <div className="p-2 bg-white rounded-[15%] text-sm text-black text-center">شحن مجاني</div>
                    <div className="p-2 bg-white rounded-[15%] text-sm text-black text-center">منتج مجاني</div>
                    <div className="p-2 bg-white rounded-[15%] text-sm text-black text-center">كاش باك</div>
                  </div>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-[#F7F7F7] rounded-[15%]">
              ...
              <div className="bg-[#F7F7F7] rounded-[15%] p-4 text-sm">
