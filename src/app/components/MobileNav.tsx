  ...
  return (
    <>
      <button
        ...
        className="lg:hidden p-2 hover:bg-[#F7F7F7] rounded-[15px] transition-colors"
      >
        ...
        <>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-80 bg-white z-50 overflow-y-auto lg:hidden">
            <div className="p-4 flex items-center justify-between">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="p-2 hover:bg-[#F7F7F7] rounded-[15px] transition-colors"
              >
            ...
            <div className="p-4">
              ...
              <div className="mt-6 pt-6">
                <button className="w-full px-4 py-2 bg-[#3B82F6] text-white text-sm rounded-[15px] hover:opacity-90 transition-all flex items-center justify-center gap-2">
